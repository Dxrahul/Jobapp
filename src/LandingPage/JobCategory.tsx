...
const JobCategory=()=>{
    ...
    <div  className="text-4xl text-center font-semibold  mb-3 text-mine-shaft-100">Browse <span className="text-bright-sun-400">Job </span>
       Category</div>
      <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w-1/2">Explore divers job opportunities tailored to your skills.Start your carrer journey today! </div>
